...
# take in two accounts
# check if account is valid
# check account balance of sufficient funds 
#if account check is false, reject transfer 
# if mony check istrue reject if money check FALSE
# if 
